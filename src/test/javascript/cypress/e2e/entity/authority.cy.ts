...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '82d20acd-2dfd-4d38-8be7-9a766a8f3384' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('14139aa6-81f7-4411-a1e5-d06f0f4a205f');
      cy.get(`[data-cy="name"]`).should('have.value', '14139aa6-81f7-4411-a1e5-d06f0f4a205f');
